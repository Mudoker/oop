...
public class OldMovieRecord extends Item{
    ...
    public OldMovieRecord(String id, String title, String rentalType, String loanType,int stock, double rentalFee, boolean activeStatus, String genre) {
        super(id, title, rentalType, loanType, stock, rentalFee, activeStatus);
        this.genre = genre;
    }

    public OldMovieRecord(String title, String rentalType, String loanType,int stock, double rentalFee, int year, String genre){
